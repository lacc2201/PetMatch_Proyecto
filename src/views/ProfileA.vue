<template>
    <div>
        ...
        <div id="profile-container" v-if="!isEditing">
            <h2 style="text-align: center; font-family: 'Arial', sans-serif; color: #f9c74f;">🐾Perfil de Usuario🐾</h2>
...
export default {
    ...
    async mounted() {
        try {
            const usuarioId = "vbsPjyluNjbA1Cr85AArQrvcVdB2";  // Aquí pones el ID del usuario que deseas cargar
            this.loadUserData(usuarioId);  // Usamos la función loadUserData para cargar los datos del usuario
        } catch (error) {
