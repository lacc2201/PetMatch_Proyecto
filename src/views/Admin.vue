...
<script>
import { cargarMascotas, cargarUsuarios, cargarReseñas } from '../firebaseConfig.js';
...
export default {
    ...
    async mounted() {
        try {
            ...
            console.log("Usuarios activos en el panel:", usuarios); // Depuración
            this.usuariosActivos = usuarios.length;

            // Cargar y contar mascotas en adopción
            const mascotas = await cargarMascotas();
            console.log("Mascotas en adopción en el panel:", mascotas); // Depuración
            this.mascotasEnAdopcion = mascotas.length;

            // Cargar y contar reseñas pendientes
            const resenas = await cargarReseñas();
            console.log("Reseñas pendientes en el panel:", resenas); // Depuración
            this.reseñasPendientes = resenas.length;
        } catch (error) {
